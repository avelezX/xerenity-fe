  ...
  return (
    <ul className="sidebar-nav">
      ...
      <SubNavItem
        name="Pricing"
        icon={faCalculator}
        active={currentPath.includes('/ndf-pricer') || currentPath.includes('/ibr-swap') || currentPath.includes('/xccy-swap') || currentPath.includes('/portfolio') || currentPath.includes('/coltes-calculator')}
      >
