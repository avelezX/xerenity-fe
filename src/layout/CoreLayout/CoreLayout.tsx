...
const RISK_PATHS = ['/risk-resumen', '/risk-management', '/futures-monitor', '/loans', '/portfolio', '/ndf-pricer', '/ibr-swap', '/xccy-swap', '/coltes-calculator', '/tes-portfolio', '/usdcop-calculator', '/marks'];
